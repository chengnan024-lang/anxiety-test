const questions = [
    "过去两周，我会因为对方回复慢而反复看手机。",
    "过去两周，我会因为对方语气变冷而怀疑关系出了问题。",
    "过去两周，我会因为一句模糊回复而反复猜测对方真实想法。",
    "过去两周，我会因为一次小冲突就预演最坏结果。",
    "过去两周，我会因为对方临时取消见面而明显焦虑。",
    "过去两周，我会因为对方状态变化而整天心神不宁。",
    "过去两周，我会因为想确认被爱而反复向对方要回应。",
    "过去两周，我会因为不安而频繁查看对方社交动态。",
    "过去两周，我会因为想安心而关注对方在线状态或定位。",
    "过去两周，我会因为对方一句安抚而情绪立刻好转。",
    "过去两周，我会因为没有及时得到回应而坐立不安。",
    "过去两周，我会因为害怕失去而很难停止联系对方。",
    "过去两周，我会因为怕对方不开心而压住真实想法。",
    "过去两周，我会因为想维持关系而降低自己的需求。",
    "过去两周，我会因为迎合对方而改变原本的生活习惯。",
    "过去两周，我会因为关系紧张而优先讨好而不是表达。",
    "过去两周，我会因为担心冲突而回避重要沟通。",
    "过去两周，我会因为关系问题而难以专注学习或工作。",
    "过去两周，我会因为关系波动而影响睡眠。",
    "过去两周，我会因为情绪反复而影响吃饭或作息。",
    "过去两周，我会因为关系内耗而减少和朋友家人的联系。",
    "过去两周，我会因为反复想关系问题而影响当天效率。"
];

const options = [
    ["每周都会这样", "经常这样", "偶尔这样", "从不这样"],
    ["每周都会这样", "经常这样", "偶尔这样", "从不这样"],
    ["每周都会这样", "经常这样", "偶尔这样", "从不这样"],
    ["每周都会这样", "经常这样", "偶尔这样", "从不这样"],
    ["每周都会这样", "经常这样", "偶尔这样", "从不这样"],
...
const brainLevels = {
    high: {name:'焦虑型依恋', emoji:'💭', desc:'过去两周，你在亲密关系中频繁出现情绪波动，强烈渴望通过各种方式确认关系的稳定性。', color:'#FF6B6B'},
    medium: {name:'波动型依恋', emoji:'🌊', desc:'过去两周，你在亲密关系中有时会出现情绪起伏，会通过一些方式寻求确认，但整体可控。', color:'#FFB74D'},
    low: {name:'安全型依恋', emoji:'🧡', desc:'过去两周，你在亲密关系中能较好地平衡投入与自我空间，情绪相对稳定。', color:'#81C784'}
};
